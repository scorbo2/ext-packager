...
public final class Version {
    ...
    public static final String APPLICATION_NAME = "ExtPackager";

    public static final String NAME = APPLICATION_NAME + " " + VERSION;
    public static String COPYRIGHT = "Copyright © 2025 Steve Corbett";

    /**
     * The directory where ExtPackager was installed -
     ...
     * to /opt/ExtPackager, but the user can override that.
     * </p>
     */
     ...
     * .ExtPackager in the user's home directory.
     */
    ...
    static {
        ...
        String appDir = System.getProperty("SETTINGS_DIR",
                                           new File(System.getProperty("user.home"), "." + APPLICATION_NAME).getAbsolutePath());
